        ...
        CSV.generate(options) do |csv|
          ...
          all.each do |repair_list_item|
            csv << [ repair_list_item.uid, \
                ...
                repair_list_item.length.present? ? repair_list_item.length.name, repair_list_item.width.present? ? repair_list_item.width.name, repair_list_item.non_mearsk_id_source, repair_list_item.is_mearsk_not_applicable, repair_list_item.mearsk_max_material_cost.dollars, \
