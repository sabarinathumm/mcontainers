...
RSpec.describe 'Employee::ActivityManagement::', type: :request do
    ...
    # valid payload
        ...
        before { get "/api/v1/activity_management/employee/activities/#{activity.id}/activity_items", headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { get "/api/v1/activity_management/employee/activities/#{activity.id}/activity_items/#{activity_item.id}" ,headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { post "/api/v1/activity_management/employee/activities/#{activity.id}/activity_items", params: valid_attributes ,headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { put "/api/v1/activity_management/employee/activities/#{activity.id}/activity_items/#{activity_item.id}", params: valid_attributes ,headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { delete "/api/v1/activity_management/employee/activities/#{activity.id}/activity_items/#{activity_item.id}", headers: headers[:auth], as: :json }
