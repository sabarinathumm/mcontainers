...
RSpec.describe 'Employee::ContainerManagement::', type: :request do
    # initialize test data 
    let!(:admin){ create(:admin) }
    let!(:headers) { get_admin_headers(admin) }
    let!(:customer){ create(:customer) }
    let!(:yard){ create(:yard) }
    let!(:container_length){ create(:container_length)}
    let!(:container_height){ create(:container_height)}
    ...
    # valid payload
        ...
        before { get '/api/v1/container_management/employee/containers', headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            let!(:valid_attributes){
                {
                    container: {
                        ...
                        container_length_id: container_length.id,
                        container_height_id: container_height.id,
            ...
            before { post '/api/v1/container_management/employee/containers', params: valid_attributes, headers: headers[:auth], as: :json }
    ...
    describe 'Update a Container' do
        # valid payload
            context 'success' do
                ...
                before { put "/api/v1/container_management/employee/containers/#{container.id}", params: valid_attributes, headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { get "/api/v1/container_management/employee/containers/#{container.id}", headers: headers[:auth], as: :json }
    ...
    describe 'Download attachments of a Container' do
        ...
        context 'success' do
            ...
            before { get "/api/v1/container_management/employee/containers/#{container.id}/download", headers: headers[:auth], as: :json }
