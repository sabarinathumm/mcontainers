...
RSpec.describe 'Admin::Auth:', type: :request do
  ...
  describe 'Login' do
    ...
    context '(success - Admin login by email and password)' do
      ...
      before { post '/api/v1/user_management/admin/auth/login', params: valid_attributes, as: :json }
  ...
  describe 'Logout' do
    ...
    context '(success)' do
      ...
      before { delete '/api/v1/user_management/admin/auth/logout', headers: headers1[:auth] }
  ...
  describe 'Forgot Password' do
    ...
    context '(success)' do
      ...
      before { post '/api/v1/user_management/admin/auth/forgot_password', params: valid_attributes, as: :json }
  ...
  describe 'Validate Reset Password Token' do
    ...
    context '(success)' do
      ...
      before { post '/api/v1/user_management/admin/auth/validate_reset_password_token', params: valid_attributes, as: :json }
    ...
    context '(reset password token is expired error)' do
      ...
      before { 
        ...
        post '/api/v1/user_management/admin/auth/validate_reset_password_token', params: valid_attributes, as: :json 
      }
  ...
  describe 'Reset password' do
    ...
    context '(success)' do
      ...
      before { put '/api/v1/user_management/admin/auth/reset_password', params: valid_attributes, as: :json }
    ...
    context '(reset password token expired error)' do
      ...
      before { 
        admin.update(reset_password_sent_at: Time.now - 20.minutes )
        put '/api/v1/user_management/admin/auth/reset_password', params: valid_attributes, as: :json 
      }
