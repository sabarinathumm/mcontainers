  ...
  let!(:repair_list){ create(:repair_list) }
    ...
    # valid payload
        context 'success' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items", headers: headers[:auth], as: :json }
        ...
        context 'Second page listing' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items?page=2", headers: headers[:auth], as: :json }

            it 'returns Second page' do
                # Note `json` is a custom helper to parse JSON responses
                #puts json
                expect(json).not_to be_empty
                expect(json['repair_list_items'].count).to eql(10)
                expect(json['repair_list_items'][0]['repair_type']['name']).to eql(repair_type.name)
                expect(json['repair_list_items'][0]['container_damaged_area']['name']).to eql(container_damaged_area.name)
                expect(json['repair_list_items'][0]['container_repair_area']['name']).to eql(container_repair_area.name)
                expect(json['repair_list_items'][0]['component']['name']).to eql(component.name)
        ...
        context 'Filtering of Repair List Items' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items?search_text=&container_repair_area_id=#{container_repair_area.id}&container_damaged_area_id=#{container_damaged_area.id}&repair_type_id=#{repair_type.id}", headers: headers[:auth], as: :json }
        ...
        context 'Sorting of Repair List Items' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items?repair_type=1", headers: headers[:auth], as: :json }
        ...
        context 'Searching of Repair List Items' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items?search_text=#{repair_list_item.first.uid}", headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { post "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items", params: valid_attributes, headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { get "/api/v1/repair_list_management/employee/repair_list/items/#{repair_list_item.id}", headers: headers[:auth], as: :json }
    ...
    describe 'Soft Delete Repair List item' do
        # valid payload
            context 'success' do
                ...
                before { delete "/api/v1/repair_list_management/employee/repair_list/items/#{repair_list_item.id}", headers: headers[:auth], as: :json }
    ...
    # valid payload
        context 'success' do
            ...
            before { put "/api/v1/repair_list_management/employee/repair_list/items/#{repair_list_item.id}", params: valid_attributes, headers: headers[:auth], as: :json }
    ...
    describe 'Export a Repair List items' do
        # valid payload
            context 'success' do
                ...
                before { get "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items/export", headers: headers[:auth], as: :json }
    ...
    describe 'Upload a Repair List item CSV' do
        # valid payload
            context 'success' do
                ...
                before { post "/api/v1/repair_list_management/employee/repair_list/#{repair_list.id}/items/upload", params: valid_attributes , \
