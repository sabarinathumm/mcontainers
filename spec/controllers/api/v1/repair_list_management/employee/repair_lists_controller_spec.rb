...
RSpec.describe 'RepairLists::', type: :request do
  ...
  let!(:unit){ create(:unit) }
    ...
    # valid payload
        ...
        before { get '/api/v1/repair_list_management/employee/repair_list', headers: headers[:auth], as: :json }
    ...
    describe 'Create Repair Lists' do
        # valid payload
            ...
            before { post '/api/v1/repair_list_management/employee/repair_list', headers: headers[:auth], as: :json }
    ...
    describe 'Update status of repair_list versions' do
        ...
        context 'success' do
            ...
            before { put "/api/v1/repair_list_management/employee/repair_list/version_activation/#{repair_list.id}", params: valid_attributes, headers: headers[:auth], as: :json }
