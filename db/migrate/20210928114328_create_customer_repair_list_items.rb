class CreateCustomerRepairListItems < ActiveRecord::Migration[6.0]
  def change
    create_table :customer_repair_list_items do |t|
      t.references :customer_repair_list, null: false, foreign_key: true
      t.string :uid
    ...
    add_index :customer_repair_list_items, [:uid, :customer_repair_list_id], unique: true, name: 'customer_repair_list_items_uid_index'
  end
end
